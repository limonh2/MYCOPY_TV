Feature: Nevada Test Regression Tests
  ...
  @tv_regression_002 @NevadaRegressionTEST @Election @NVIND
  ...
  @tv_regression_007 @NevadaRegressionTEST @Election @NVIND
  ...
  @tv_regression_008 @NevadaRegressionTEST @Ballots @NVIND
  Scenario: Create Ballot Question and Create ballot styles in County
    ...
    And User click the Save button on the Add new Election Page
    Then the new election should be created successfully
    #Creates a Ballot Question and Create Ballot Styles
    And User select "Ballot Set Up" from "Election Management"
  ...
  @tv_regression_009 @NevadaRegressionTEST @Voter @NVIND
  ...
  @tv_regression_010 @NevadaRegressionTEST @Voter @NVIND
  ...
  @tv_regression_011 @NevadaRegressionTEST @Voter @Candidate
...
#  Prerequisites: created a new or existed Voter
  ...
  @tv_regression_012 @NevadaRegressionTEST @Voter @NVIND
  ...
  @tv_regression_013 @NevadaRegressionTEST @Voter
  ...
  @tv_regression_014 @NevadaRegressionTEST @Voter @NVIND
  ...
  @tv_regression_015 @NevadaRegressionTEST @Voter @NVIND
  ...
  @tv_regression_016 @NevadaRegressionTEST @Voter
  ...
  @tv_regression_017 @NevadaRegressionTEST @Notice @NVIND
  ...
  @tv_regression_018 @NevadaRegressionTEST @PollingPlace @NVIND
  ...
  @tv_regression_019 @NevadaRegressionTEST @PollingPlace @NVIND
  Scenario: Assign Polling Place LocationPass to an Election
    Given User navigate to "NV_Test" log in page
    And User log in as "core_county" user
    And User select "Polling Locations" from "Election Management"
    And User click on "Assign to Election"
    And User select "2023 Primary - 06/04/2024 - 1748" from "Election"
  ...
  @tv_regression_020 @NevadaRegressionTEST @PollingPlace @NVIND
  Scenario: Assign and Edit Polling Place Location
    ...
    And User selects "2023 Primary - 06/04/2024 - 1748" from election dropdown in Polling Place
  ...
  @tv_regression_021 @NevadaRegressionTEST @TA @NVIND
  ...
  @tv_regression_022 @NevadaRegressionTEST @Report @NVIND
  ...
  @tv_regression_023 @NevadaRegressionTEST @Report @NVIND
  ...
  @tv_regression_024 @NevadaRegressionTEST @Report
  ...
  @tv_regression_025 @NevadaRegressionTEST @Voter @NVIND
  ...
  @tv_regression_029 @NevadaRegressionTEST @Notice
  ...
  @tv_regression_030 @NevadaRegressionTEST @Candidate
  ...
  @tv_regression_031 @NevadaRegressionTEST @Ballots @NVIND
  ...
  @tv_regression_032 @NevadaRegressionTEST @Ballots @NVIND
  Scenario: Verify Ballot Question is displaying District Type and District Name correctly
    ...
    And User click the Save button on the Add new Election Page
    Then the new election should be created successfully
    #erify Ballot Question is displaying District Type and District Name correctly
    And User select "Ballot Set Up" from "Election Management"
  ...
  @tv_regression_033 @NevadaRegressionTEST @Voter
  ...
  @tv_regression_034 @NevadaRegressionTEST @Voter

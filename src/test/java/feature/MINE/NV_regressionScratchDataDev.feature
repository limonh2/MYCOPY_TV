Feature: Nevada Dev Regression Tests
  ...
  @tv_regression_001 @NevadaRegressionFRESHDEV @Election @NVIND
  Scenario: Scenario: Creating an Election and Adding a Contest and Candidate to the Election created in State
    ...
    And User fills in the required information fields for creating election related functions
      ...
      | Office                 | SW - OFFICE STATEWIDE - 10/1/2024 | dropdown |
  ...
  @tv_regression_002 @NevadaRegressionFRESHDEV @Election @NVIND
  ...
  @tv_regression_007 @NevadaRegressionFRESHDEV @Election @NVIND
  ...
  @tv_regression_008 @NevadaRegressionFRESHDEV @Ballots @NVIND
  ...
  @tv_regression_009 @NevadaRegressionFRESHDEV @Voter @NVIND
  ...
  @tv_regression_010 @NevadaRegressionFRESHDEV @Voter @NVIND
  ...
  @tv_regression_011 @NevadaRegressionFRESHDEV @Voter @Candidate
...
#  Prerequisites: created a new or existed Voter
  ...
  @tv_regression_012 @NevadaRegressionFRESHDEV @Voter @NVIND
  ...
  @tv_regression_013 @NevadaRegressionFRESHDEV @Voter
  ...
  @tv_regression_014 @NevadaRegressionFRESHDEV @Voter @NVIND
  ...
  @tv_regression_015 @NevadaRegressionFRESHDEV @Voter @NVIND
  ...
  @tv_regression_016 @NevadaRegressionFRESHDEV @Voter
  ...
  @tv_regression_017 @NevadaRegressionFRESHDEV @Notice @NVIND
  ...
  @tv_regression_018 @NevadaRegressionFRESHDEV @PollingPlace @NVIND
  ...
  @tv_regression_019 @NevadaRegressionFRESHDEV @PollingPlace @NVIND
  ...
  @tv_regression_020 @NevadaRegressionFRESHDEV @PollingPlace @NVIND
  ...
  @tv_regression_021 @NevadaRegressionFRESHDEV @TA @NVIND
  ...
  @tv_regression_022 @NevadaRegressionFRESHDEV @Report @NVIND
  ...
  @tv_regression_023 @NevadaRegressionFRESHDEV @Report @NVIND
  ...
  @tv_regression_024 @NevadaRegressionFRESHDEV @Report
  ...
  @tv_regression_025 @NevadaRegressionFRESHDEV @Voter @NVIND
  ...
  @tv_regression_029 @NevadaRegressionFRESHDEV @Notice
  ...
  @tv_regression_030 @NevadaRegressionFRESHDEV @Candidate
  ...
  @tv_regression_031 @NevadaRegressionFRESHDEV @Ballots @NVIND
  ...
  @tv_regression_032 @NevadaRegressionFRESHDEV @Ballots @NVIND
  ...
  @tv_regression_033 @NevadaRegressionFRESHDEV @Voter
  ...
  @tv_regression_034 @NevadaRegressionFRESHDEV @Voter
...
#  @tv_regression_0xxx @NevadaRegressionFRESHDEV @Election
